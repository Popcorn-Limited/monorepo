...
contract MasterChefV2AdapterTest is AbstractAdapterTest {
    ...
    function setUp() public {
        ...
        testConfigStorage = ITestConfigStorage(
            address(new MasterChefV2TestConfigStorage())
        );
    ...
    function verify_adapterInit() public override {
        ...
        assertEq(
            asset.allowance(address(adapter), address(masterChef)),
            type(uint256).max,
            "allowance"
        );
    }
    ...
    function test__claim() public override {
        ...
        assertGt(
            IERC20(0x471Ea49dd8E60E697f4cac262b5fafCc307506e4).balanceOf(
                address(adapter)
            ),
            0
        );
