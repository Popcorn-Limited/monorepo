...
import NewsletterSubscription from "@popcorn/components/components/NewsletterSubscription";
...
const Footer = () => {
  ...
  return (
    <footer className="grid grid-cols-12 smmd:gap-14 px-6 smmd:px-8 pb-10 mt-20 font-landing">
