...
interface ButterBatchProcessingV1Interface extends ethers.utils.Interface {
  functions: {
...
export class ButterBatchProcessingV1 extends BaseContract {
  ...
  interface: ButterBatchProcessingV1Interface;
