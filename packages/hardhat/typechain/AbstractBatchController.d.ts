...
interface AbstractBatchControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class AbstractBatchController extends BaseContract {
  ...
  interface: AbstractBatchControllerInterface;
