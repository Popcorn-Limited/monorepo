...
interface MockCurveFactory2MetapoolInterface extends ethers.utils.Interface {
  functions: {
...
export class MockCurveFactory2Metapool extends BaseContract {
  ...
  interface: MockCurveFactory2MetapoolInterface;
