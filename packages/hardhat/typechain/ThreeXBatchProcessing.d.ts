...
interface ThreeXBatchProcessingInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setComponents(address[],tuple[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setComponents",
    values: [
      string[],
      {
        lpToken: string;
  ...
  events: {
    ...
    "ComponentDependenciesUpdated(address[],tuple[])": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ComponentDependenciesUpdated"
  ): EventFragment;
...
export type ComponentDependenciesUpdatedEvent = TypedEvent<
  [
    string[],
    ...
    components: string[];
    componentDependencies: ([string, string, string, string, string] & {
      lpToken: string;
      utilityPool: string;
      oracle: string;
      curveMetaPool: string;
...
export class ThreeXBatchProcessing extends BaseContract {
  ...
  interface: ThreeXBatchProcessingInterface;
  ...
  filters: {
    ...
    "ComponentDependenciesUpdated(address[],tuple[])"(
      components?: null,
