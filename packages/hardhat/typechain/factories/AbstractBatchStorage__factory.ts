...
import type {
  ...
  AbstractBatchStorageInterface,
} from "../AbstractBatchStorage";
...
export class AbstractBatchStorage__factory {
  static readonly abi = _abi;
  static createInterface(): AbstractBatchStorageInterface {
    return new utils.Interface(_abi) as AbstractBatchStorageInterface;
  }
  static connect(
    address: string,
