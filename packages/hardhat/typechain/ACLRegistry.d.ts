...
interface ACLRegistryInterface extends ethers.utils.Interface {
  functions: {
    "APPROVED_CONTRACT_ROLE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "APPROVED_CONTRACT_ROLE",
    values?: undefined
  ): string;
...
export class ACLRegistry extends BaseContract {
  ...
  interface: ACLRegistryInterface;

  functions: {
    APPROVED_CONTRACT_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    APPROVED_CONTRACT_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
