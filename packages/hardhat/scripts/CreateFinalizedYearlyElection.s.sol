...
contract CreateElection is Script {
  ...
  GrantElections.ElectionTerm ELECTION_TERM = GrantElections.ElectionTerm.Yearly;
  ...
  function run() external {
    ...
    grantElection.setConfiguration(
      ...
      5, // awardees cutoff
      false, // VRF
      10 * 60, // Registration period - default
      10 * 60, // Voting period - default
      1 * DAYS, // cooldown period - default
      0, // bondAmount
      false, // bond required
